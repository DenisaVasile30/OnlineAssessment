 ...
 */
final class Version20230430115612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE created_quiz ADD practice_quiz TINYINT(1) DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE supported_assessment CHANGE started_at started_at DATETIME DEFAULT NULL, CHANGE ended_at ended_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE created_quiz DROP practice_quiz');
    }
}
