 ...
 */
final class Version20230414164844 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE supported_assessment CHANGE started_at started_at DATETIME NOT NULL, CHANGE ended_at ended_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE tickets ADD multiple_assign_to LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE `tickets` DROP multiple_assign_to');
