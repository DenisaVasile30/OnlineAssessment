 ...
 */
final class Version20230426145021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz_questions CHANGE choice_d choice_d VARCHAR(500) DEFAULT NULL');
//        $this->addSql('ALTER TABLE supported_assessment CHANGE started_at started_at DATETIME NOT NULL, CHANGE ended_at ended_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `quiz_questions` CHANGE choice_d choice_d VARCHAR(500) NOT NULL');
