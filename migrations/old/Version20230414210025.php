 ...
 */
final class Version20230414210025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE students DROP faculty');
//        $this->addSql('ALTER TABLE supported_assessment CHANGE started_at started_at DATETIME NOT NULL, CHANGE ended_at ended_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `students` ADD faculty VARCHAR(500) NOT NULL');
